...
then
    ...
    curl -LO https://github.com/macports/macports-base/releases/download/v2.12.5/MacPorts-2.12.5-15-Sequoia.pkg
    sudo installer -verbose -pkg MacPorts-2.12.5-15-Sequoia.pkg -target /
    rm MacPorts-2.12.5-15-Sequoia.pkg
