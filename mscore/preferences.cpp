...
void Preferences::init(bool storeInMemoryOnly)
      ...
      _allPreferences = prefs_map_t(
      {
            ...
            {PREF_SCORE_PLAYBACK_CURSOR_MOVE_BY_BEAT,              new BoolPreference(false, true)},
            {PREF_SCORE_PLAYBACK_CURSOR_BACKGROUND,                new BoolPreference(true, true)},
            {PREF_SCORE_PLAYBACK_HIGHLIGHT_NOTES,                  new BoolPreference(true)},
            ...
            {PREF_UI_CANVAS_CONTINUOUS_HEADER_VISIBLE,             new BoolPreference(true)},
            {PREF_UI_CANVAS_CONTINUOUS_HEADER_COLOR,               new ColorPreference(QColor(0x385F94))},
            {PREF_UI_CANVAS_CONTINUOUS_HEADER_INSTRUMENT,          new BoolPreference(true)},
            {PREF_UI_CANVAS_CONTINUOUS_HEADER_MEASURE,             new BoolPreference(true)},
            ...
            {PREF_UI_SCORE_OVERRIDE_ALL_ELEMENTS_COLOR,            new ColorPreference(QColor(Qt::black))},
            {PREF_UI_SCORE_OVERRIDE_BARLINES_COLOR,                new ColorPreference(QColor(Qt::black))},
            {PREF_UI_SCORE_OVERRIDE_BOX_TEXT_COLOR,                new ColorPreference(QColor(Qt::black))},
            {PREF_UI_SCORE_OVERRIDE_BRACKETS_COLOR,                new ColorPreference(QColor(Qt::black))},
            {PREF_UI_SCORE_OVERRIDE_DYNAMICS_COLOR,                new ColorPreference(QColor(Qt::black))},
            {PREF_UI_SCORE_OVERRIDE_EVEN_STAFF_ELEMENTS_COLOR,     new ColorPreference(QColor(Qt::black))},
            {PREF_UI_SCORE_OVERRIDE_EXPRESSION_TEXT_COLOR,         new ColorPreference(QColor(Qt::black))},
            {PREF_UI_SCORE_OVERRIDE_FINGERING_TEXT_COLOR,          new ColorPreference(QColor(Qt::black))},
            {PREF_UI_SCORE_OVERRIDE_HARMONY_TEXT_COLOR,            new ColorPreference(QColor(Qt::black))},
            {PREF_UI_SCORE_OVERRIDE_LEDGER_LINES_COLOR,            new ColorPreference(QColor(Qt::black))},
            {PREF_UI_SCORE_OVERRIDE_NOTEHEAD_ALTERATION_COLOR_ENABLED,  new BoolPreference(false)},
            ...
            {PREF_UI_PIANOROLL_DARK_NOTE_UNSEL_COLOR_EVEN,         new ColorPreference(QColor(0xcc1d5a))},
            ...
            {PREF_UI_PIANOROLL_LIGHT_NOTE_UNSEL_COLOR_EVEN,        new ColorPreference(QColor(0xcc1d5a))},
