...
Note* Score::findOrCreateTieTarget(Note* note)
      ...
      //
      // Ordinary tie-forward semantics are strictly local:
      // only consider the rhythmic position immediately following
      // the source note.
      //
      ...
      //
      // Second preference: same pitch in another voice on the
      // same staff.  This permits an ordinary forward tie to cross
      // voices when the immediately following note already exists
      // there.
      //
      ...
      //
      // No matching pitch exists at the next rhythmic position.
      // Follow the MuseScore 4-style behavior and create the
      // continuation in the source voice, replacing whatever
      // ChordRest occupies that position.
      //
      if (!cr) {
