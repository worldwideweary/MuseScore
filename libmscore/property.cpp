...
static constexpr PropertyMetaData propertyList[] = {
      ...
      { Pid::HAIRPIN_PIANO_STYLE,     true,  "hairpinPianoStyle",     P_TYPE::BOOL,                DUMMY_QT_TRANSLATE_NOOP("propertyName", "hairpin piano style") },
...
//100
      ...
      { Pid::FRET_GUIDES,             true,  "showGuides",            P_TYPE::BOOL,                DUMMY_QT_TRANSLATE_NOOP("propertyName", "show guides")      },
      { Pid::FRET_INTERVALS,          true,  "showIntervals",         P_TYPE::BOOL,                DUMMY_QT_TRANSLATE_NOOP("propertyName", "show intervals")   },
      { Pid::FRET_NAMES,              true,  "showNames",             P_TYPE::BOOL,                DUMMY_QT_TRANSLATE_NOOP("propertyName", "show note names")  },
...
//200
      ...
      { Pid::VOICE,                   true,  "voice",                 P_TYPE::INT,                 DUMMY_QT_TRANSLATE_NOOP("propertyName", "voice")            },
