...
static constexpr PropertyMetaData propertyList[] = {
      ...
      { Pid::EN_PASSANT_MANIFEST,       P_TYPE::BOOL,           false, "enPassantManifest",      DUMMY_QT_TRANSLATE_NOOP("propertyName", "temporarily make visible during playback")      },
      ...
      { Pid::GATE_TIME,                 P_TYPE::GATE_TIME,      true,  "gateTime",               DUMMY_QT_TRANSLATE_NOOP("propertyName", "gate time")                                     },
      { Pid::ON_TIME,                   P_TYPE::ON_TIME,        true,  "onTime",                 DUMMY_QT_TRANSLATE_NOOP("propertyName", "on time")                                       },
      { Pid::VELOCITY_OFFSET,           P_TYPE::VELOCITY_OFFSET,true,  "velocityOffset",         DUMMY_QT_TRANSLATE_NOOP("propertyName", "velocity offset")                               },
      ...
      { Pid::CENTER_SINGLE_CHORD,       P_TYPE::BOOL,           false, "centerSingleChord",      DUMMY_QT_TRANSLATE_NOOP("propertyName", "single chord is centered in measure")           },
      ...
      { Pid::FRET_GUIDES,               P_TYPE::BOOL,           true,  "showGuides",             DUMMY_QT_TRANSLATE_NOOP("propertyName", "show guides")                                   },
      { Pid::FRET_INTERVALS,            P_TYPE::BOOL,           true,  "showIntervals",          DUMMY_QT_TRANSLATE_NOOP("propertyName", "show intervals")                                },
      { Pid::FRET_NAMES,                P_TYPE::BOOL,           true,  "showNames",              DUMMY_QT_TRANSLATE_NOOP("propertyName", "show note names")                               },
